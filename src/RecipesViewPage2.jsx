...
import Card from '../components/Card'; // Assicurati che il file si chiami Card.jsx
...
const RecipesViewPage = () => {
  ...
  if (status === 'loading') return <p style={{ padding: '2rem' }}>Caricamento ricette...</p>;
  if (status === 'failed') return <p style={{ padding: '2rem', color: 'red' }}>Errore: {error}</p>;
